...
from contracts.jediswap.utils.math import (
    uint256_checked_add,
...
func initializer{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    token0: felt, token1: felt, proxy_admin: felt
) {
...
// @return address
@view
func token0{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (address: felt) {
...
// @return address
@view
func token1{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (address: felt) {
...
func swap{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    let (local is_balance0_greater_than_expected_balance0) = uint256_lt(
        expected_balance0, balance0
    );
    let (local is_balance1_greater_than_expected_balance1) = uint256_lt(
        expected_balance1, balance1
    );
...
func _mint_protocol_fee{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    local fee_on = is_not_zero(fee_to);
