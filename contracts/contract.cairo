...
from contracts.util import almost_equal as aeq
...
func increase_balance{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    increase_balance_called.emit(current_balance=res, amount=amount1+amount2);
    return ();
}
...
@view
func get_block{syscall_ptr: felt*}() -> (res: felt) {
...
@view
func get_timestamp{syscall_ptr: felt*}() -> (res: felt) {
